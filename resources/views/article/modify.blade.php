...
@section('content')
    ...
    <h1> 修改文章</h1>
    <form class="form-horizontal" method="post" action="/article/modify">
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10" style=" padding-right: 15px;padding-left: 15px; width: 75%">
                <input type="text" class="form-control" id="inputEmail3" name="title" placeholder="题目" value="{{$article->title}}">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div id="content" style="margin: 0px;">
                    <textarea style="display: none" name="content" id="text">{{$article->content}}</textarea>
                </div>
            </div>
        </div>
        </div>
